...
export default function ServicesSection() {
  return (
    <section id="servicos" className="w-full bg-white py-16 lg:py-24">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-8">
        ...
        <div className="flex flex-col gap-16">
              ...
              <div key={service.id} className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden group h-full flex flex-col border border-slate-100/50">
                ...
                <div className="p-6 lg:p-8 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto">
                    <Button asChild variant="outline" className="w-full border-primary/20 text-primary hover:bg-primary/10 group rounded-full">
          ...
          <FadeIn direction="up" className="text-center">
            <div className="bg-orange-500 backdrop-blur-sm rounded-3xl p-16 text-white border border-orange-500/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" className="bg-white text-orange-500 hover:bg-orange-50 border border-orange-200 text-base px-8 py-3 shadow-lg rounded-full">
                  <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer">
                    Falar com Sara
                  </a>
                </Button>
                <Button size="lg" className="bg-white text-orange-500 hover:bg-orange-50 border border-orange-200 text-base px-8 py-3 shadow-lg rounded-full">
                  Solicitar Proposta
                </Button>
              </div>
            </div>
