...
export default function ContactSection() {
  return (
    <section id="contato" className="w-full bg-gradient-to-br from-slate-50 to-white py-16 lg:py-24">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2">
              <FadeIn direction="up" className="space-y-8">
                ...
                {/* WhatsApp CTA */}
                <Button asChild size="lg" className="bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 text-white hover:from-orange-500 hover:via-orange-600 hover:to-orange-700 text-base px-8 py-3 shadow-lg shadow-orange-500/30 rounded-full w-full">
              ...
              <FadeIn direction="up" className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-slate-100/50 p-8 lg:p-10">
                ...
                <form className="space-y-6">
                  ...
                  <Button 
                    type="submit" 
                    size="lg" 
                    className="bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 text-white hover:from-orange-500 hover:via-orange-600 hover:to-orange-700 text-base px-8 py-3 shadow-lg shadow-orange-500/30 rounded-full w-full"
                  >
                    Enviar mensagem
