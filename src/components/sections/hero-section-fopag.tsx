      ...
      <FadeIn direction="up" className="space-y-8">
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-6">
            <Button asChild size="lg" className="bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 text-white hover:from-orange-500 hover:via-orange-600 hover:to-orange-700 text-base px-8 py-3 shadow-lg shadow-orange-500/30 rounded-full">
              <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer">
                Fale com a Sara
                <ArrowRight className="w-4 h-4 ml-2" />
              </a>
            </Button>
            <Button variant="outline" size="lg" className="border-orange-400 text-orange-500 hover:bg-orange-50 hover:border-orange-500 hover:text-orange-600 text-base px-8 py-3 rounded-full">
              Conhecer Serviços
            </Button>
          </div>
        </div>
