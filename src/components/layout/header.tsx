...
import { Menu, ArrowRight, Home, User, FileText, Phone, MessageCircle } from 'lucide-react';
...
export default function Header() {
  ...
  return (
    <header className={cn(
      ...
      <div className={cn(
          "flex h-16 items-center justify-between transition-all duration-300 w-full px-6 sm:px-8 lg:px-8",
          isScrolled 
